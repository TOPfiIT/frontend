      ...
      <div className={styles.vacancyResults}>
        ...
        <div className={styles.intervieweeCard}>
          <div className={styles.intervieweeInfo}>
            ...
            <p className={styles.intervieweeResume}>Резюме: <a href="#">https://drive.google.com/resume/alexey_ivanov.pdf</a></p>
          </div>
          <div className={styles.intervieweeStat}>
            <div className={styles.intervieweeLogoContainer}>
              <img className={styles.intervieweeLogo} src="/timer" alt="timer icon" />
            </div>
            <p className={styles.intervieweeStat}>Потрачено 1:19:54</p>
            <div className={styles.intervieweeSplit}></div>
            <p className={styles.intervieweeStat}>На задания потрачено соответственно: 0:00:01, 1:09:53, 0:10:00</p>
            <div className={styles.intervieweeSplit}></div>
            <p className={styles.intervieweeStat}>Заданий выполнено: 3</p>
            <div className={styles.intervieweeSplit}></div>
            <p className={styles.intervieweeStat}>Количество подозрительных копирований: 3</p>
          </div>
          ...
          <div className={styles.intervieweeNumbers}>
            ...
            <p className={styles.intervieweeStat}>Оценка чистоты кода: 4/5</p>
            <div className={styles.intervieweeSplit}></div>
            <p className={styles.intervieweeStat}>Оценка понимания: 3/5</p>
          </div>
          ...
          <div className={styles.intervieweeVerdict}>
            ...
            <p className={styles.intervieweeStat}>Итоговая оценка уровня: middle</p>
            <div className={styles.intervieweeSplit}></div>
            <p className={styles.intervieweeStat}>Рекомендация: казнить</p>
          </div>
        </div>
